...
<div class="wrapper">
    ...
    <div class="main_content">
        <div class="header">Request For Account</div>  
        <div class="info">
 ...
 <tbody id="request-acctable">
       <?php
          ...
          <tr>
            ...
            <td>
              <a href="" title="View" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter<?= $row['id'] ?>"><i class="fas fa-eye"></i></a>
